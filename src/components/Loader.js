...
//import bg from './image0_0.jpg'
import bg2 from './pexels-cottonbro-9665177.jpg'
...
const Loader = () => {
    ...
    return ( 
        <div className=" flex flex-col justify-center items-center">
            <p className="font-black text-white text-9 font-bellfair-reg ">404 NOT FOUND</p>
            <Link to="/" className="underline  w-auto h-10 text-white font-black font-barlow-conLight text-4">Back to home page...</Link>
